...
function Vision() {
  const { data, loading } = useFetch("/notice/81");
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white">
          <div className="flex-col">
            <h1 className="text-5xl font-bold text-center">Vision & Mission</h1>
            <div className="text-center mt-4 text-gray-400">
              <p className="text-white text-xl">Home/ <span>Vision & Mission</span></p>
            </div>
          </div>
        </div>
      </div>
